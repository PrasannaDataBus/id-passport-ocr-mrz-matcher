...
### Dependencies:
-------------
1. Run the following to install Python dependencies:

```bash
pip install passporteye pycountry pytesseract pdf2image pillow opencv-python
```

2. After Install the below local system:
- Tesseract OCR (`tesseract.exe`)
- Poppler (for PDF rendering, `poppler-25.07.0`)

3. Run the following to install Python dependencies:
